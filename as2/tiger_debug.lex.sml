...
fun yyAction41 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (Tokens.INT(intFromString(yytext),yypos,yypos+size(yytext)))
      end
       ...
       of NONE => yyAction25(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction25(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
            else if inp = #"A"
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp = #"A"
        ...
        | SOME(inp, strm') =>
            if inp = #"\f"
              ...
              then if inp = #"\t"
                  ...
                  then yyAction1(strm, yyNO_MATCH)
                  else yyQ90(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
            else if inp = #" "
              then yyQ90(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"\f"
              ...
              then if inp = #"\t"
                  ...
                  then yyAction0(strm, yyNO_MATCH)
                  else yyQ90(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
            else if inp = #" "
              then yyQ90(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))

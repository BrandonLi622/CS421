...
type size
(* Tree.stm describes the syntax of the intermediate syntax tree
    of the tiger language. Translate is the module responsible 
    for transforming the Absyn into a tree *)

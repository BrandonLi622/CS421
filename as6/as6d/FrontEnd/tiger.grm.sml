...
|  ( 5, ( ( _, ( MlyValue.nonvalue nonvalue1, nonvalue1left, 
nonvalue1right)) :: rest671)) => let val  result = MlyValue.exp (fn _
 => let val  (nonvalue as nonvalue1) = nonvalue1 ()
 in (nonvalue)
end)
 in ( LrTable.NT 0, ( result, nonvalue1left, nonvalue1right), rest671)

end
|  ( 6, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( MlyValue.expseq 
...
|  ( 20, ( ( _, ( MlyValue.funcal funcal1, funcal1left, funcal1right))
 :: rest671)) => let val  result = MlyValue.exp (fn _ => let val  (
...
|  ( 23, ( ( _, ( _, _, RBRACE1right)) :: ( _, ( MlyValue.rec_list 
...
|  ( 24, ( ( _, ( MlyValue.arr_cre arr_cre1, arr_cre1left, 
...
|  ( 30, ( ( _, ( _, _, END1right)) :: ( _, ( MlyValue.exp exp1, _, _)
...
|  ( 31, ( ( _, ( _, _, END1right)) :: ( _, ( MlyValue.expseq expseq1,
...
|  ( 34, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( _, LPAREN1left, _))
 :: rest671)) => let val  result = MlyValue.nonvalue (fn _ => (
A.SeqExp([])))
 in ( LrTable.NT 5, ( result, LPAREN1left, RPAREN1right), rest671)
end
|  ( 35, ( ( _, ( _, _, RPAREN1right)) :: _ :: ( _, ( MlyValue.ID ID1,
 (IDleft as ID1left), _)) :: rest671)) => let val  result = 
...
|  ( 36, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( MlyValue.args args1,
...
|  ( 38, ( ( _, ( MlyValue.args args1, _, args1right)) :: _ :: ( _, ( 
...
|  ( 40, ( ( _, ( MlyValue.rec_list rec_list1, _, rec_list1right)) ::
...
|  ( 48, ( ( _, ( MlyValue.tydec_list tydec_list1, _, tydec_list1right
...
|  ( 55, ( ( _, ( MlyValue.tyid tyid1, _, tyid1right)) :: _ :: ( _, ( 
MlyValue.ID ID1, (IDleft as ID1left), _)) :: rest671)) => let val  
...
|  ( 56, ( ( _, ( MlyValue.one_or_more one_or_more1, _, 
...
|  ( 60, ( ( _, ( MlyValue.fundec_list fundec_list1, _, 
...
|  ( 65, ( ( _, ( MlyValue.tyid tyid1, _, tyid1right)) :: _ :: ( _, ( 
MlyValue.ID ID1, (IDleft as ID1left), _)) :: rest671)) => let val  
...
|  ( 69, ( ( _, ( MlyValue.ID ID1, _, ID1right)) :: ( _, ( _, DOTleft,
...
|  ( 72, ( ( _, ( MlyValue.exp exp2, exp2left, exp2right)) :: _ :: ( _
, ( MlyValue.exp exp1, exp1left, _)) :: rest671)) => let val  result =
...
|  ( 73, ( ( _, ( MlyValue.expseq expseq1, _, expseq1right)) :: _ :: (
...
exp1 ()
 ...
 in ( LrTable.NT 4, ( result, exp1left, expseq1right), rest671)
end
